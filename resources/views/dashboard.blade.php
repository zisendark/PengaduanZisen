                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">Endang</th>
                            <td class="px-4 py-3">Mikail</td>
                            <td class="px-4 py-3">XI RPL 2</td>
                            <td class="px-4 py-3">Pencabulan</td>
                            <td class="px-4 py-3">Kamera cctv</td>
